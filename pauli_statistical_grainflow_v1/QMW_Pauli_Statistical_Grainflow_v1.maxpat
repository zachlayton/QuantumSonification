{
  "patcher": {
    ...
    "boxes": [
      {
        "box": {
          ...
          "text": "QMW PAULI STATISTICAL GRAINFLOW v1 \u2014 THE ENERGY SHELL",
          "fontsize": 18.0
        }
      },
      {
        "box": {
          ...
          "text": "Quantum wavetable atlas -> six addressed streams -> exact occupation scheduler -> dual Grainflow 2.1 engines. Grains are events; streams are modes; particle labels never enter the renderer."
        }
      },
      {
        "box": {
      ...
      },
      {
        "box": {
          ...
          "text": "js qmw_quantum_wavetable_atlas_v1.js",
          "numinlets": 1,
          "numoutlets": 3,
          "outlettype": [
            "",
      ...
      },
      {
        "box": {
          ...
          "text": "js qmw_pauli_grainflow_scheduler_v1.js",
          "numinlets": 1,
          "numoutlets": 4,
          "outlettype": [
            "",
    ...
    "dependency_cache": [
      {
        "name": "qmw_quantum_wavetable_atlas_v1.js",
        "type": "TEXT"
      },
      {
        "name": "qmw_pauli_grainflow_scheduler_v1.js",
        "type": "TEXT"
      },
      {
