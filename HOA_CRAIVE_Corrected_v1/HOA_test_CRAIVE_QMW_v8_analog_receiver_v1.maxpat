{
    "patcher": {
        ...
        "boxes": [
            ...
            },
            {
                "box": {
                    "id": "obj-qmw-decoder",
                    "maxclass": "newobj",
                    "text": "spat5.hoa.decoder~ @order 3 @dimension 3D @outputs 134 @mc 1 @initwith \"/norm SN3D, /method energy-preserving, /powercompensation 1\"",
                    "patching_rect": [
                        18,
                        710,
                        650,
            ...
            },
            {
                "box": {
                    "id": "obj-qmw-layout",
                    "maxclass": "newobj",
                    "text": "qmw_craive_hoa134_layout_v1",
                    "patching_rect": [
                        700,
                        710,
                        214,
            ...
            },
            {
                "box": {
                    ...
                    "maxclass": "comment",
                    "text": "Third-order ACN/SN3D HOA → 134 verified CRAIVE speaker feeds",
                    "patching_rect": [
                        18,
                        685,
                        430,
            ...
            },
            {
                "box": {
                    ...
                    "maxclass": "comment",
                    "text": "The hardware sink exposes slots 1–142. This decoder intentionally drives verified loudspeakers 1–134 only; slots 135–142 remain silent.",
                    "patching_rect": [
                        23,
                        885,
                        850,
        ...
        "dependency_cache": [
            ...
            {
                "name": "qmw_craive_hoa134_layout_v1.maxpat",
                "bootpath": ".",
                "patcherrelativepath": ".",
                "type": "JSON",
                "implicit": 1
