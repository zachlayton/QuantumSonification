...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 923.0, 12.0, 143.0, 33.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 334.5, 79.0, 231.0, 20.0 ],
					"text" : "qac_ibm_wavetable_bridge.py",
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 10.0, 22.0, 850.0, 27.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 10.0, 56.0, 647.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 10.0, 78.0, 235.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 477.0, 885.0, 440.0, 22.0 ],
					"text" : "sender ready"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 175.0, 540.0, 703.0, 35.0 ],
					"text" : "o.route /qmw/wavetable/points /qmw/wavetable/status /qmw/wavetable/error /qmw/wavetable/correlations /qmw/wavetable/pauli15 /qmw/wavetable/surface_file /qmw/quantum/features /qmw/quantum/state /qmw/qft/bins /qmw/qft/amplitudes /qmw/qft/phases"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 10.0, 715.0, 880.0, 100.0 ],
					"size" : 256,
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 15.0, 854.0, 75.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 92.0, 855.0, 95.0, 20.0 ],
					"text" : "frequency Hz",
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 327.0, 885.0, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 407.0, 840.0, 62.0, 20.0 ],
					"text" : "STATUS",
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 482.0, 852.0, 408.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 592.0, 635.0, 65.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 672.0, 635.0, 65.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 592.0, 662.0, 230.0, 20.0 ],
					"text" : "XX                 YY                 ZZ",
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 10.0, 100.0, 780.0, 390.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 926.0, 536.0, 120.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 926.0, 564.0, 140.0, 35.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 735.0, 1.0, 231.0, 87.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 10.0, 505.0, 880.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 10.0, 532.0, 880.0, 90.0 ],
					"setstyle" : 1,
					"size" : 15,
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 202.0, 855.0, 75.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 477.0, 828.0, 390.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 107.0, 945.0, 72.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 815.5, 396.5, 126.0, 47.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 966.0, 481.0, 158.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 10.0, 920.0, 450.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 10.0, 942.0, 72.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 10.0, 970.0, 90.0, 20.0 ],
					"text" : "polarization"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 107.0, 970.0, 90.0, 20.0 ],
					"text" : "entanglement"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 207.0, 945.0, 72.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 207.0, 970.0, 100.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 317.0, 945.0, 72.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 317.0, 970.0, 100.0, 20.0 ],
					"text" : "Z entropy"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 452.0, 920.0, 480.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 452.0, 945.0, 72.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 532.0, 945.0, 72.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 652.0, 945.0, 72.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 732.0, 945.0, 72.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 832.0, 945.0, 60.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 897.0, 945.0, 60.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 832.0, 970.0, 139.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 791.0, 81.0, 75.0, 20.0 ],
					"text" : "target qubit"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 791.0, 110.0, 150.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"saved_object_attributes" : 					{
						"filename" : "qmw_compact_state_renderer_v5.js",
						"parameter_enable" : 0
					}
,
					"text" : "js qmw_compact_state_renderer_v5.js"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 12.0, 644.0, 280.0, 22.0 ],
					"text" : "buffer~ qmw_v5_local @samps 1024 @channels 1"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "buffer~ qmw_v5_ibm @samps 1024 @channels 1"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 12.0, 1005.0, 75.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 92.0, 1007.0, 210.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 322.0, 996.0, 70.0, 22.0 ],
					"text" : "mode ifft"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 397.0, 996.0, 85.0, 22.0 ],
					"text" : "mode spline"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 487.0, 996.0, 90.0, 22.0 ],
					"text" : "mode density"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 582.0, 996.0, 85.0, 22.0 ],
					"text" : "mode hybrid"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 322.0, 1028.0, 65.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 392.0, 1030.0, 125.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 522.0, 1028.0, 65.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 592.0, 1030.0, 120.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 717.0, 1028.0, 65.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 592.0, 690.0, 65.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 672.0, 690.0, 65.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 592.0, 715.0, 295.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 15.0, 672.0, 306.0, 22.0 ],
					"text" : "buffer~ qmw_v5_ir_local @samps 262144 @channels 1"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "buffer~ qmw_v5_ir_ibm @samps 262144 @channels 1"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "set 1 1 qmw_v5_ir_local 1"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 948.5, 797.0, 75.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 948.5, 820.0, 180.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 923.0, 385.0, 190.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 919.0, 355.0, 138.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 1280.0, 540.0, 225.0, 22.0 ],
					"saved_object_attributes" : 					{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "bang" ],
					"patching_rect" : [ 1280.0, 580.0, 300.0, 22.0 ],
					"text" : "buffer~ qmw_v5_qft_wave @samps 256 @channels 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 1280.0, 620.0, 160.0, 22.0 ],
					"text" : "wave~ qmw_v5_qft_wave"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 1280.0, 655.0, 62.0, 22.0 ],
					"text" : "*~ 0.12"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 900.0, 620.0, 360.0, 180.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 795.0, 167.0, 360.0, 180.0 ],
					"sync" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 900.0, 805.0, 360.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 795.0, 352.0, 360.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 900.0, 595.0, 362.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 795.0, 142.0, 362.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 5,
					"outlettype" : [ "", "", "", "", "" ],
					"patching_rect" : [ 1280.0, 700.0, 320.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1280.0, 735.0, 360.0, 49.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1280.0, 765.0, 360.0, 49.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1280.0, 795.0, 362.0, 49.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "float", "float", "float" ],
					"patching_rect" : [ 1280.0, 830.0, 110.0, 22.0 ],
					"text" : "unpack f f f"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 300.0, 1080.0, 75.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 944.0, 714.0, 75.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 380.0, 1082.0, 95.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 944.0, 690.0, 95.0, 20.0 ],
					"text" : "IR return gain"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 300.0, 1110.0, 82.0, 22.0 ],
					"text" : "loadmess 0.5"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 490.0, 1080.0, 75.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 948.5, 744.0, 75.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 570.0, 1082.0, 105.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 943.5, 770.0, 105.0, 20.0 ],
					"text" : "IR size / decay"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 490.0, 1110.0, 78.0, 22.0 ],
					"text" : "loadmess 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 575.0, 1110.0, 95.0, 22.0 ],
					"text" : "prepend irsize"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 680.0, 1080.0, 75.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 941.0, 852.0, 75.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 760.0, 1082.0, 100.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 1021.0, 854.0, 100.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 680.0, 1110.0, 78.0, 22.0 ],
					"text" : "loadmess 3."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 765.0, 1110.0, 98.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "bang" ],
					"patching_rect" : [ 880.0, 1110.0, 310.0, 22.0 ],
					"text" : "buffer~ qmw_v5_difference @samps 1024 @channels 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 880.0, 1140.0, 175.0, 22.0 ],
					"text" : "2d.wave~ qmw_v5_difference"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 870.0, 1080.0, 75.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 949.0, 884.0, 75.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 950.0, 1082.0, 125.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 1029.0, 886.0, 125.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 1065.0, 1140.0, 52.0, 22.0 ],
					"text" : "sig~ 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 1125.0, 1140.0, 42.0, 22.0 ],
					"text" : "*~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 700.0, 1180.0, 42.0, 22.0 ],
					"text" : "+~"
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "difference_gain_sig", 0 ],
					"source" : [ "difference_gain", 0 ]
				}

			}
, 			{
				"patchline" : 				{
					"destination" : [ "difference_mul", 1 ],
					"source" : [ "difference_gain_sig", 0 ]
				}

			}
, 			{
				"patchline" : 				{
					"destination" : [ "comparison_sum", 1 ],
					"source" : [ "difference_mul", 0 ]
				}

			}
, 			{
				"patchline" : 				{
					"destination" : [ "difference_mul", 0 ],
					"source" : [ "difference_wave", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "ir_wet_return_trim", 1 ],
					"source" : [ "ir_return_gain", 0 ]
				}

			}
, 			{
				"patchline" : 				{
					"destination" : [ "ir_return_gain", 0 ],
					"source" : [ "ir_return_gain_default", 0 ]
				}

			}
, 			{
				"patchline" : 				{
					"destination" : [ "ir_scale_prepend", 0 ],
					"source" : [ "ir_scale", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "ir_scale", 0 ],
					"source" : [ "ir_scale_default", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "ir_size", 0 ],
					"source" : [ "ir_size_default", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "v3_renderer", 0 ],
					"source" : [ "ir_size_prepend", 0 ]
				}

			}
, 			{
				"patchline" : 				{
					"destination" : [ "ir_wet_return_trim", 0 ],
					"source" : [ "ir_wet_mul", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "qft_spectrum_renderer", 2 ],
					"source" : [ "oroute", 10 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "qft_spectrum_renderer", 1 ],
					"source" : [ "oroute", 9 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "qft_descriptor_unpack", 0 ],
					"source" : [ "qft_data_route", 3 ]
				}

			}
, 			{
				"patchline" : 				{
					"destination" : [ "qft_magnitude_list", 1 ],
					"source" : [ "qft_data_route", 1 ]
				}

			}
, 			{
				"patchline" : 				{
					"destination" : [ "qft_phase_list", 1 ],
					"source" : [ "qft_data_route", 2 ]
				}

			}
, 			{
				"patchline" : 				{
					"destination" : [ "qft_probability_list", 1 ],
					"source" : [ "qft_data_route", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "qft_data_route", 0 ],
					"source" : [ "qft_spectrum_renderer", 2 ]
				}

			}
, 			{
				"patchline" : 				{
					"destination" : [ "qft_spectrogram", 0 ],
					"source" : [ "qft_spectrum_renderer", 1 ]
				}

			}
, 			{
				"patchline" : 				{
					"destination" : [ "qft_spectrum_status", 0 ],
					"source" : [ "qft_spectrum_renderer", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "qft_wave_gain", 0 ],
					"source" : [ "qft_wave_reader", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "qft_spectrum_route", 0 ],
					"order" : 0,
					"source" : [ "udp", 0 ]
				}
...
, 			{
				"name" : "qmw_compact_state_renderer_v5.js",
				"bootpath" : "~/QuantumSonification/max",
				"patcherrelativepath" : ".",
				"type" : "TEXT",
				"implicit" : 1
