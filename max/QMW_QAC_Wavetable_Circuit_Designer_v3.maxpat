{
	"patcher": {
		...
		"boxes": [
			...
			},
			{
				"box": {
					...
					"text": "QAC CIRCUIT DESIGNER V3 \u2192 COMPACT STATE \u2192 DUAL RENDERERS",
					"textcolor": [
						0.85,
						0.93,
						1.0,
			...
			},
			{
				"box": {
					...
					"saved_object_attributes": {
						"filename": "qmw_compact_state_renderer_v3.js",
						"parameter_enable": 0
					},
					"text": "js qmw_compact_state_renderer_v3.js"
				}
			},
			{
				"box": {
					...
					"text": "buffer~ qmw_v3_local @samps 1024 @channels 1"
				}
			},
			{
				"box": {
					...
					"text": "buffer~ qmw_v3_ibm @samps 1024 @channels 1"
				}
			},
			{
				"box": {
			...
			},
			{
				"box": {
					...
					"text": "buffer~ qmw_v3_ir_local @samps 262144 @channels 1"
				}
			},
			{
				"box": {
					...
					"text": "buffer~ qmw_v3_ir_ibm @samps 262144 @channels 1"
				}
			},
			{
				"box": {
			...
			},
			{
				"box": {
					...
					"text": "set 1 1 qmw_v3_ir_local 1"
				}
			},
			{
				"box": {
		...
		"dependency_cache": [
			...
			{
				"name": "qmw_compact_state_renderer_v3.js",
				"bootpath": "~/QuantumSonification/max",
				"patcherrelativepath": ".",
				"type": "TEXT",
				"implicit": 1
