...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 160.0, 944.0, 78.0, 22.0 ],
					"text" : "phasor~ 0."
				}
...
, 			{
				"box" : 				{
					...
					"text" : "QAC CIRCUIT DESIGNER → LOCAL / IBM → 256-POINT WAVETABLE",
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 28.0, 110.0, 235.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"text" : "o.route /qmw/wavetable/points /qmw/wavetable/status /qmw/wavetable/error /qmw/wavetable/correlations /qmw/wavetable/pauli15 /qmw/wavetable/surface_file /qmw/quantum/features"
				}
...
, 			{
				"box" : 				{
					...
					"saved_object_attributes" : 					{
						"filename" : "qmw_wavetable_receiver_v1.js",
						"parameter_enable" : 0
					}
,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 28.0, 680.0, 880.0, 150.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 28.0, 662.0, 880.0, 150.0 ],
					"size" : 256,
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 820.0, 426.0, 287.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 790.0, 827.0, 125.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 930.0, 453.0, 125.0, 20.0 ],
					"text" : "SEND theta CIRCUIT"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 805.0, 855.0, 165.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 820.0, 507.0, 165.0, 20.0 ],
					"text" : "RZ uses H -> RZ -> CX"
				}
