// Local four-voice router for QMW_Sonification_Rack_Module_v3.maxpat.
autowatch = 1;
inlets = 4;
outlets = 4;
...
var listPrefixes = {
    magnitude: "m", phase: "ph", speed: "s",
    harmonic: "h", harmonics: "h", gap: "h"
};

var scalarParams = {
    purity: true, entropy: true, coherence: true, amp: true,
    default_freq: true, attack_ms: true, slow_decay_ms: true,
    fast_decay_ms: true, magnitude_smooth_ms: true,
    phase_smooth_ms: true, brightness: true, mix_voices: true,
    output_ceiling: true
};
