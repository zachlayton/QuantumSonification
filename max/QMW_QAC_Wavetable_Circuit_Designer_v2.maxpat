...
, 			{
				"box" : 				{
					...
					"text" : "QAC CIRCUIT DESIGNER V2 → QUANTUM FEATURES → 2D WAVETABLE",
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 930.0, 453.0, 158.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 335.0, 1025.0, 42.0, 22.0 ],
					"text" : "sig~"
				}
