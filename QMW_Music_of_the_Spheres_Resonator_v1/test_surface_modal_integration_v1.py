...
sys.path.insert(0, str(HERE / "molecular_geometry_layer_v1"))
sys.path.insert(0, str(HERE / "developmental_fields_v1"))
sys.path.insert(0, str(HERE / "emergent_geometry_v1_osc"))
...
from spectral_geometry_v1 import MeshSpectralGeometry, SpectralGeometryConfig
...
def test_surface_model_sources_are_synchronized() -> None:
    ...
    bundle_source = (
        HERE / "surface_material_models_v1" / "surface_material_models_v1.py"
    )
