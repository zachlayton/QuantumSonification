...
```text
~/QuantumSonification/geometry/emergent_geometry_engine_v1.py
```
...
python geometry/emergent_geometry_engine_v1.py \
  --preset labyrinth \
  --size 192 \
  --steps 12000 \
  --export-state geometry/output/emergent_labyrinth_v1.npz \
  --export-descriptors geometry/output/emergent_labyrinth_v1.json \
  --export-obj geometry/output/emergent_labyrinth_v1.obj \
  --export-png-prefix geometry/output/emergent_labyrinth_v1
```
...
python geometry/emergent_geometry_engine_v1.py \
  ...
  --steps 2000 \
  --report-every 500 \
  --export-png-prefix geometry/output/test_v1
```
...
python emergent_geometry_osc_v1.py \
  --preset labyrinth \
  --size 192 \
  --rate 20 \
  --iterations 4 \
