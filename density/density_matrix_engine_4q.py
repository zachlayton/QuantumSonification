...
class DensityMatrixEngine:
    ...
    def __init__(self, excitation_source: str = "internal"):
    ...
    def set_excitation_source(self, source: str) -> None:
        ...
        if source in ("hydrogen", "hydrogen_spectrum", "spectrum"):
            ...
            raise ValueError(
                "Unknown excitation source. Use internal, hydrogen_spectrum, "
                "hydrogen_orbital, schrodinger_packet, or schrodinger_interference."
            )

        self.excitation_source_kind = source
