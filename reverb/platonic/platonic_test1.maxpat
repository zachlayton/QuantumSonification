...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 115.0, 58.0, 47.0, 22.0 ],
					"text" : "* 0.125"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 183.5, 566.0, 87.0, 22.0 ],
					"text" : "pauli_depth $1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 618.0, 281.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 610.0, 51.0, 41.0, 22.0 ],
					"text" : "loop 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 362.0, 462.0, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 502.0, 46.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 265.0, 90.0, 187.0, 22.0 ]
				}
...
, 			{
				"name" : "qmw_platonic_geometry_controller_v1.js",
				"bootpath" : "~/QuantumSonification/reverb/platonic",
				"patcherrelativepath" : ".",
				"type" : "TEXT",
				"implicit" : 1
			}
