/*
    qmw_coherence_feedback_gain16_v2.js
    ...
    coherence and entropy while preserving a known fixed baseline.
        ...
        gain = depth * (manual_span
            + quantum_span * coherence * (1 - entropy_damping*entropy))
...
var entropy = 0.0;
var depth = 0.0;
// v2 guarantees that Feedback Depth has an audible manual component.
// Coherence adds bounded variation instead of acting as an on/off prerequisite.
var manualSpan = 0.18;
var dynamicSpan = 0.12;
...
function emitGain() {
    ...
    var gain = depth * (manualSpan
        + dynamicSpan * coherence * organization);
    ...
    outlet(2, ["feedback_gain", gain, "coherence", coherence,
        ...
        "manual_span", manualSpan, "quantum_span", dynamicSpan]);
}
...
function baseline(value) {
    // Retained for compatibility: baseline now means guaranteed manual span.
    manualSpan = clip(value, 0.0, hardCap);
    emitGain();
}
