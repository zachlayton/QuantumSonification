    ...
    "boxes": [
      {
        "box": {
          ...
          "fontsize": 22.0,
          "fontface": 1,
          "text": "QMW Density-Matrix Hilbert Operator \u2014 16 MC v2",
          "patching_rect": [
            30.0,
            18.0,
            600.0,
      ...
      },
      {
        "box": {
          ...
          "maxclass": "comment",
          "fontsize": 13.0,
          "text": "v2 fixes physical outlet order: y_re / y_im / audition / diagnostics. Status can never enter a signal rail.",
          "patching_rect": [
            31.0,
            52.0,
            820.0,
