...
def main_patch() -> dict[str, Any]:
    boxes = [
        box("title", "comment", [30., 20., 1100., 32.], text="QMW HEISENBERG — 16-BODY COMPLEX MATRIX RINGS INSTRUMENT v2", fontsize=20., fontface=1),
        ...
        new("adapter", "js qmb_heisenberg_adapter_v2.js", [30., 255., 245., 22.], 1, 7),
        ...
        new("controller", "js qmb_heisenberg_rings_controller_v2.js", [300., 300., 285., 22.], 1, 3),
        ...
        new("poly_router", "js qmb_heisenberg_rings_poly_router_v2.js", [610., 345., 270., 22.], 1, 1),
        new("poly", "poly~ qmb_heisenberg_rings_voice_v2 16", [610., 390., 260., 22.], 1, 2, ["signal", "signal"]),
        ...
        box("phase_depth_label", "comment", [30., 875., 205., 22.], text="PHASE → RINGS DEPTH", fontface=1),
        box("phase_depth", "flonum", [240., 875., 65., 22.], minimum=0.0, maximum=1.0, numinlets=1, numoutlets=2, outlettype=["", "bang"]),
        new("phase_depth_prepend", "prepend phase_depth", [315., 875., 145., 22.], 1, 1),
        box("phase_depth_off", "message", [470., 875., 32., 22.], text="0.", numinlets=2, numoutlets=1, outlettype=[""]),
        box("phase_depth_default", "message", [510., 875., 38., 22.], text="0.65", numinlets=2, numoutlets=1, outlettype=[""]),
        box("phase_depth_full", "message", [556., 875., 32., 22.], text="1.", numinlets=2, numoutlets=1, outlettype=[""]),
        ...
        box("clock_label", "comment", [30., 1100., 610., 22.], text="QUANTUM TEMPORAL MACHINE — commits follow density-matrix displacement", fontface=1),
        box("clock_quantum", "message", [30., 1135., 250., 22.], text="/qmw/bridge/clock/timing quantum", numinlets=2, numoutlets=1, outlettype=[""]),
        box("clock_rate", "message", [290., 1135., 225., 22.], text="/qmw/bridge/clock/timing rate", numinlets=2, numoutlets=1, outlettype=[""]),
        box("distance_label", "comment", [530., 1135., 125., 22.], text="BURES DISTANCE"),
        box("clock_distance", "flonum", [660., 1135., 75., 22.], minimum=0.000001, maximum=3.141593, numinlets=1, numoutlets=2, outlettype=["", "bang"]),
        new("distance_prepend", "prepend /qmw/bridge/clock/distance", [745., 1135., 250., 22.], 1, 1),
        box("clock_poisson", "message", [30., 1170., 265., 22.], text="/qmw/bridge/clock/process poisson", numinlets=2, numoutlets=1, outlettype=[""]),
        box("clock_fixed", "message", [305., 1170., 245., 22.], text="/qmw/bridge/clock/process fixed", numinlets=2, numoutlets=1, outlettype=[""]),
        box("coherence_label", "comment", [565., 1170., 145., 22.], text="COHERENCE DEPTH"),
        box("coherence_depth", "flonum", [715., 1170., 70., 22.], minimum=0.0, maximum=1.0, numinlets=1, numoutlets=2, outlettype=["", "bang"]),
        new("coherence_prepend", "prepend /qmw/bridge/clock/coherence_depth", [795., 1170., 300., 22.], 1, 1),
        box("clock_note", "comment", [30., 1205., 1070., 36.], text="Smaller distance = more events. Poisson varies the threshold around that distance; fixed uses an exact distance. Coherence depth 0…1 makes changing off-diagonal relationships accelerate/decelerate the clock."),
        box("morph_label", "comment", [30., 1260., 360., 22.], text="VOICE MAPPING CROSSFADE — relational 0 ←→ component 1", fontface=1),
        box("mapping_morph", "flonum", [400., 1260., 70., 22.], minimum=0.0, maximum=1.0, numinlets=1, numoutlets=2, outlettype=["", "bang"]),
        new("morph_prepend", "prepend mapping_morph", [480., 1260., 155., 22.], 1, 1),
        box("morph_rel", "message", [650., 1260., 32., 22.], text="0.", numinlets=2, numoutlets=1, outlettype=[""]),
        box("morph_mid", "message", [690., 1260., 38., 22.], text="0.5", numinlets=2, numoutlets=1, outlettype=[""]),
        box("morph_comp", "message", [736., 1260., 32., 22.], text="1.", numinlets=2, numoutlets=1, outlettype=[""]),
        box("voice_map_label", "comment", [30., 1300., 760., 22.], text="PER-VOICE MAP — voice_map <1…16 | 0=all> <destination> <source> <amount -1…1>", fontface=1),
        box("map_example_1", "message", [30., 1335., 235., 22.], text="voice_map 1 brightness real 1.", numinlets=2, numoutlets=1, outlettype=[""]),
        box("map_example_2", "message", [275., 1335., 275., 22.], text="voice_map 1 damping magnitude -0.5", numinlets=2, numoutlets=1, outlettype=[""]),
        box("map_example_3", "message", [560., 1335., 255., 22.], text="voice_map 7 structure phase 0.4", numinlets=2, numoutlets=1, outlettype=[""]),
        box("map_example_all", "message", [825., 1335., 260., 22.], text="voice_map 0 position imag 0.6", numinlets=2, numoutlets=1, outlettype=[""]),
        box("map_clear", "message", [30., 1370., 135., 22.], text="voice_map_clear 0", numinlets=2, numoutlets=1, outlettype=[""]),
        box("map_sources", "comment", [180., 1370., 900., 22.], text="sources: magnitude real imag phase frequency pan     destinations: structure brightness damping position"),
        box("cell_map_label", "comment", [30., 1410., 850., 22.], text="RAW REALTIME CELL MAP — cell_map <voice> <destination> <list> <column 1…16> <amount>", fontface=1),
        box("cell_example_1", "message", [30., 1445., 270., 22.], text="cell_map 1 brightness real 4 1.", numinlets=2, numoutlets=1, outlettype=[""]),
        box("cell_example_2", "message", [310., 1445., 300., 22.], text="cell_map 2 damping magnitude 9 0.7", numinlets=2, numoutlets=1, outlettype=[""]),
        box("cell_example_3", "message", [620., 1445., 280., 22.], text="cell_map 7 structure imag 12 -0.5", numinlets=2, numoutlets=1, outlettype=[""]),
        box("cell_example_all", "message", [910., 1445., 270., 22.], text="cell_map 0 position phase 8 0.4", numinlets=2, numoutlets=1, outlettype=[""]),
        box("cell_clear", "message", [30., 1480., 130., 22.], text="cell_map_clear 0", numinlets=2, numoutlets=1, outlettype=[""]),
        box("run_note", "comment", [30., 790., 540., 70.], text="Static proof: run heisenberg_instrument_v1.heisenberg_lab_v1. Live motion: run quantumsonification_conductor.py on 7421 plus qmb_conductor_density_bridge_v2. Max continues to receive committed matrices on 7400."),
    ]
    lines = [
        ...
        *[line(name, 0, "phase_norm") for name in ("phase_0", "phase_y", "phase_pi", "phase_minus_y", "phase_tau")],
        line("phase_depth", 0, "phase_depth_prepend"), line("phase_depth_prepend", 0, "controller"),
        *[line(name, 0, "phase_depth") for name in ("phase_depth_off", "phase_depth_default", "phase_depth_full")],
        ...
        *[line(name, 0, "phase_send") for name in ("clock_quantum", "clock_rate", "clock_poisson", "clock_fixed")],
        line("clock_distance", 0, "distance_prepend"), line("distance_prepend", 0, "phase_send"),
        line("coherence_depth", 0, "coherence_prepend"), line("coherence_prepend", 0, "phase_send"),
    ...
    dependencies = [
        ...
        {"name": "qmb_heisenberg_adapter_v2.js", "type": "TEXT"},
        {"name": "qmb_heisenberg_rings_controller_v2.js", "type": "TEXT"},
        {"name": "qmb_heisenberg_rings_poly_router_v2.js", "type": "TEXT"},
        {"name": "qmb_heisenberg_rings_voice_v2.maxpat", "type": "JSON"},
    ]
    return patcher([45., 40., 1210., 1540.], boxes, lines, dependencies)
...
def main() -> int:
    ...
    validate(voice)
    validate(instrument)
    (ROOT / "qmb_heisenberg_rings_voice_v2.maxpat").write_text(json.dumps(voice, indent=2) + "\n", encoding="utf-8")
    (ROOT / "QMW_Heisenberg_Rings_Matrix_Instrument_v2.maxpat").write_text(json.dumps(instrument, indent=2) + "\n", encoding="utf-8")
    print("generated qmb_heisenberg_rings_voice_v2.maxpat")
    print("generated QMW_Heisenberg_Rings_Matrix_Instrument_v2.maxpat")
    return 0
