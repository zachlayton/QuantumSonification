{
  "patcher": {
    ...
    "boxes": [
      {
        "box": {
          ...
          "text": "QMW HEISENBERG \u2014 16-BODY COMPLEX MATRIX RINGS INSTRUMENT v2",
          "fontsize": 20.0,
          "fontface": 1
        }
      },
      ...
      },
      {
        "box": {
          ...
          "text": "js qmb_heisenberg_adapter_v2.js",
          "numinlets": 1,
          "numoutlets": 7,
          "outlettype": [
            "",
      ...
      },
      {
        "box": {
          ...
          "text": "js qmb_heisenberg_rings_controller_v2.js",
          "numinlets": 1,
          "numoutlets": 3,
          "outlettype": [
            "",
      ...
      },
      {
        "box": {
          ...
          "text": "js qmb_heisenberg_rings_poly_router_v2.js",
          "numinlets": 1,
          "numoutlets": 1,
          "outlettype": [
            ""
      ...
      },
      {
        "box": {
          ...
          "text": "poly~ qmb_heisenberg_rings_voice_v2 16",
          "numinlets": 1,
          "numoutlets": 2,
          "outlettype": [
            "signal",
      ...
      },
      {
        "box": {
          ...
          "text": "QUANTUM TEMPORAL MACHINE \u2014 commits follow density-matrix displacement",
          "fontface": 1
        }
      },
      {
        "box": {
          ...
          "text": "/qmw/bridge/clock/timing quantum",
          "numinlets": 2,
          "numoutlets": 1,
          "outlettype": [
            ""
      ...
      },
      {
        "box": {
          ...
          "text": "/qmw/bridge/clock/timing rate",
          "numinlets": 2,
          "numoutlets": 1,
          "outlettype": [
            ""
      ...
      },
      {
        "box": {
          ...
          "text": "prepend /qmw/bridge/clock/distance",
          "numinlets": 1,
          "numoutlets": 1,
          "outlettype": [
            ""
      ...
      },
      {
        "box": {
          ...
          "text": "/qmw/bridge/clock/process poisson",
          "numinlets": 2,
          "numoutlets": 1,
          "outlettype": [
            ""
      ...
      },
      {
        "box": {
          ...
          "text": "/qmw/bridge/clock/process fixed",
          "numinlets": 2,
          "numoutlets": 1,
          "outlettype": [
            ""
      ...
      },
      {
        "box": {
          ...
          "text": "prepend /qmw/bridge/clock/coherence_depth",
          "numinlets": 1,
          "numoutlets": 1,
          "outlettype": [
            ""
      ...
      },
      {
        "box": {
          ...
          "text": "Smaller distance = more events. Poisson varies the threshold around that distance; fixed uses an exact distance. Coherence depth 0\u20261 makes changing off-diagonal relationships accelerate/decelerate the clock."
        }
      },
      {
        "box": {
      ...
      },
      {
        "box": {
          ...
          "text": "Static proof: run heisenberg_instrument_v1.heisenberg_lab_v1. Live motion: run quantumsonification_conductor.py on 7421 plus qmb_conductor_density_bridge_v2. Max continues to receive committed matrices on 7400."
        }
      }
    ],
    "lines": [
    ...
    "dependency_cache": [
      ...
      {
        "name": "qmb_heisenberg_adapter_v2.js",
        "type": "TEXT"
      },
      {
        "name": "qmb_heisenberg_rings_controller_v2.js",
        "type": "TEXT"
      },
      {
        "name": "qmb_heisenberg_rings_poly_router_v2.js",
        "type": "TEXT"
      },
      {
        "name": "qmb_heisenberg_rings_voice_v2.maxpat",
        "type": "JSON"
      }
    ],
    "autosave": 0
