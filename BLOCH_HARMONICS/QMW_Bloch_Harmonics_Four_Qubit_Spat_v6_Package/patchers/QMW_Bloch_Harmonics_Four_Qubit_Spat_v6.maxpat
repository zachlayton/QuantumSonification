...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"text" : "FOUR-QUBIT GENEXPR RESONATORS + GLOBAL DENSITY FIELD + SPAT5 v6"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "signal" ],
					"patching_rect" : [ 1030.0, 1235.0, 190.0, 22.0 ],
					"text" : "qmw_four_qubit_spat5~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1250.0, 1360.0, 105.0, 22.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"text" : "q0–q3 reduced Bloch states drive four separate eight-mode GenExpr banks.\nGlobal 16×16 purity, entropy and coherence remain shared; Spat5 opens automatically."
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1290.0, 1325.0, 65.0, 22.0 ],
					"presentation" : 1,
...
, 			{
				"name" : "qmw_four_qubit_spat5~.maxpat",
				"bootpath" : "~/QuantumSonification/BLOCH_HARMONICS/bloch_harmonics_four_qubit_spat_v6",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
