...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 700.0, 55.0, 30.0, 30.0 ]
				}

			}
, 			{
				"box" : 				{
					"comment" : "replace IR B",
					"id" : "in_ir_b",
					"index" : 5,
					"maxclass" : "inlet",
					"numinlets" : 0,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 760.0, 55.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"text" : "QMW Bloch harmonic resonator → dual-geometry IR convolution"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "read qmw_ir_tanglecube.wav"
				}
...
, 			{
				"box" : 				{
					"comment" : "left wet output",
					"id" : "out_l",
					"index" : 1,
					"maxclass" : "outlet",
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 60.0, 575.0, 30.0, 30.0 ]
				}

			}
, 			{
				"box" : 				{
					"comment" : "right wet output",
					"id" : "out_r",
					"index" : 2,
					"maxclass" : "outlet",
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 165.0, 575.0, 30.0, 30.0 ]
				}
