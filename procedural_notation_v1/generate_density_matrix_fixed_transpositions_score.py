"""Generate a density canon using five fixed full-set transpositions."""
...
FIXED_TRANSPOSITION_TIMES = (0.30, 0.65, 1.0, 1.35, 1.70)


def main() -> Path:
    density_canon = build_density_matrix_cable_net_canon(
        build_tensile_saddle_mesh(),
        build_density_matrix_snapshots(FIXED_TRANSPOSITION_TIMES),
    ...
    score = build_polyphonic_timed_score(
        ...
        beats_per_measure=4,
        ticks_per_quarter=8,
        title="Density Matrix Five-Transposition Canon No. 12",
    ...
    output = (
        ...
        / "output"
        / "density_matrix_five_fixed_transpositions_canon_12.musicxml"
    )
