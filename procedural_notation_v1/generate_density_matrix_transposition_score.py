"""Generate a density-matrix canon with observable and phase transposition."""
...
def main() -> Path:
    ...
    score = build_polyphonic_timed_score(
        ...
        beats_per_measure=4,
        ticks_per_quarter=8,
        title="Four-Qubit Density Matrix Transposition Canon No. 11",
    ...
    output = (
        ...
        / "output"
        / "four_qubit_density_matrix_transposition_canon_11.musicxml"
    )
