...
from heisenberg_instrument_v1.build_qmw_heisenberg_rings_matrix_instrument_v1 import (
    main_patch,
    voice_patch,
)
...
class RingsMatrixInstrumentTests(unittest.TestCase):
    def test_main_patch_uses_sixteen_voice_poly_and_separate_memory(self) -> None:
        ...
        self.assertEqual(boxes["poly"]["text"], "poly~ qmb_heisenberg_rings_voice_v1 16")
        self.assertEqual(
            boxes["poke"]["text"],
