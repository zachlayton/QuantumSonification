...
vm.runInContext(fs.readFileSync(path.join(__dirname, "qmb_heisenberg_rings_controller_v1.js"), "utf8"), context);
...
console.log("qmb_heisenberg_rings_controller_v1: all tests passed");
