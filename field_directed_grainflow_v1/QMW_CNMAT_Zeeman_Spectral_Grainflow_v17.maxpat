{
  "patcher": {
    ...
    "boxes": [
      ...
      },
      {
        "box": {
          ...
          "text": "QMW CNMAT ZEEMAN SPECTRAL GRAINFLOW v17 \u2014 A/B"
        }
      },
      {
        "box": {
      ...
      },
      {
        "box": {
          ...
          "text": "CNMAT MODEL: eigenfield cells \u2192 paired Zeeman frequency/gain/decay triples"
        }
      },
      {
        "box": {
          ...
          "text": "o.route /qmw/conductor/eigenfield/grid/4 /qmw/conductor/zeeman /qmw/density_field/coherence /qmw/density_field/entropy",
          "numinlets": 1,
          "numoutlets": 5,
          "outlettype": [
            "list",
      ...
      },
      {
        "box": {
          ...
          "text": "js qmw_cnmat_zeeman_model_v17.js",
          "numinlets": 4,
          "numoutlets": 3,
          "outlettype": [
            "list",
      ...
      },
      {
        "box": {
          ...
          "text": "waiting for CNMAT spectral model",
          "numinlets": 2,
          "numoutlets": 1,
          "outlettype": [
            ""
      ...
      },
      {
        "box": {
          ...
          "text": "RESONATOR A/B: 0=V16, 1=CNMAT"
        }
      },
      {
        "box": {
    ...
    "dependency_cache": [
      {
        "name": "qmw_cnmat_zeeman_model_v17.js",
