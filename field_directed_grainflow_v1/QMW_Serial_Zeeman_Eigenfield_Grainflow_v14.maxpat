{
  "patcher": {
    ...
    "boxes": [
      ...
      },
      {
        "box": {
          ...
          "text": "QMW SERIAL ZEEMAN \u2192 EIGENFIELD GRAINFLOW v14"
        }
      },
      {
        "box": {
      ...
      },
      {
        "box": {
          ...
          "text": "grainflow~ qmw_zeeman_live 8 @delayRandom 500"
        }
      },
      {
        "box": {
      ...
      },
      {
        "box": {
          ...
          "text": "SERIAL SOURCE: Zeeman bank \u2192 mono live buffer \u2192 GrainFlow \u2192 stereo field"
        }
      },
      {
        "box": {
          ...
          "text": "buffer~ qmw_zeeman_live 4000 1",
          "numinlets": 1,
          "numoutlets": 2,
          "outlettype": [
            "float",
      ...
      },
      {
        "box": {
          ...
          "text": "record~ qmw_zeeman_live @loop 1",
          "numinlets": 3,
          "numoutlets": 1,
          "outlettype": [
            "signal"
      ...
      },
      {
        "box": {
          ...
          "text": "There is no direct Zeeman output in v14. Field motion changes carrier/splitting; the resulting waveform is heard only after it has entered the granular channel."
        }
      }
    ],
    "lines": [
    ...
    "dependency_cache": [
      {
        "name": "qmw_eigenfield_density_display_v13.js",
